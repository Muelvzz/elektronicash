...
export default function ContactUs() {
  ...
  const formInputStyles = "w-full rounded-lg border border-slate-300 bg-white px-4 py-2 outline-none transition focus:border-slate-500 focus:ring-2 focus:ring-slate-200"
      ...
      <div className="flex flex-col md:flex-row gap-x-10">
        <div className="w-full max-w-lg rounded-[32px] bg-slate-100 p-8 shadow-[0_20px_70px_rgba(15,23,42,0.12)]">
          <div className="mb-8 text-left">
            <h2 className="uppercase tracking-[0.2em] text-(--neutral-color)">
              Get in Touch
            </h2>
        ...
        <div className="w-full max-w-lg rounded-[32px] bg-white/90 p-6 shadow-[0_20px_70px_rgba(15,23,42,0.08)] flex flex-col justify-center gap-y-10">
          <div className="text-left">
            <h2 className="text-lg font-semibold text-slate-900 uppercase tracking-[0.2em]">
              Contact Information
            </h2>
          </div>
